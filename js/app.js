...
function createTodoHTML(todo) {
    ...
    <div class="card-footer d-flex justify-content-between">
        <small><i class="bi bi-file-earmark-plus-fill"></i> ${dateFormatter.format(todo.createdAt)}</small>
        ${todo.updatedAt ? `<small><i class="bi bi-check-circle-fill"></i> ${dateFormatter.format(todo.updatedAt)}</small>` : ''}
    </div>
  </div>`
}
